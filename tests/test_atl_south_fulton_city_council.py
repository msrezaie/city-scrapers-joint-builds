...
import pytest
from city_scrapers_core.constants import PASSED, CITY_COUNCIL
...
def test_links(parsed_items):
    assert parsed_items[0]["links"] == [
        {
            "title": "Agenda",
            "href": "https://southfultonga.portal.civicclerk.com/event/1744/files/agenda/2261",
        },
        {
            "title": "Agenda Packet",
            "href": "https://southfultonga.portal.civicclerk.com/event/1744/files/agenda/2262",
        },
    ]
